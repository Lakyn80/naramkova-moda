...
def product_list():
    ...
    # Basic pagination defaults to satisfy template (no real paging yet)
    ...
    return render_template(
        ...
        selected_has_image=bool(request.args.get("has_image")),
        selected_has_media=bool(request.args.get("has_media")),
