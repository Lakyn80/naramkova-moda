...
import { Mail, Phone, Cookie, Shield, X, MapPin } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-5 text-[11px] sm:text-sm">
          ...
          <div className="space-y-0.5 text-left">
            ...
            <p className="flex items-start gap-2">
              ...
              <a
                href="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d10456.935322313719!2d17.45560902150076!3d49.063189791767364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1zTmEgTW9yw6F2Y2UgZXYuIMSNLiAyMCwgVWhlcnNrw6kgSHJhZGnFoXTEmyA2ODYgMDE!5e0!3m2!1scs!2scz!4v1764883239087!5m2!1scs!2scz"
                target="_blank"
                rel="noopener noreferrer"
                className="font-semibold text-white hover:text-pink-300 leading-tight"
              >
                Osobní vyzvednutí<br />
                Na Morávce ev. č. 20<br />
