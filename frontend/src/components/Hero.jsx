  ...
  return (
    ...
    >
      <div className="backdrop-blur-sm bg-white/20 rounded-2xl p-6 sm:p-10 shadow-2xl w-full max-w-xl md:max-w-3xl text-center animate-float z-10">
        ...
        <p className="mt-4 text-lg sm:text-xl text-pink-700 font-medium">
          Ozdobte se jedinečností ✨
        </p>
        <button
          onClick={handleExploreClick}
          className="mt-8 w-full sm:w-auto px-8 py-3 bg-pink-700 hover:bg-pink-800 text-white font-semibold rounded-full shadow-lg transition duration-300"
        >
          Prozkoumat nabídku
        </button>
      </div>
