...
export default function CookiesPolicy() {
  return (
    <section className="pt-24 pb-12 px-4 max-w-3xl mx-auto">
      ...
      <p className="mb-3">
        Nastavení souhlasu můžeš kdykoli změnit smazáním souboru <code>cookie_consent</code> nebo přes odkaz v patičce „Nastavení cookies“ (doporučeno přidat).
      </p>
      <p>
        Dotazy k souborům cookies: <a className="underline" href="mailto:info@naramkova-moda.cz">info@naramkova-moda.cz</a>.
      </p>
    </section>
  );
}
